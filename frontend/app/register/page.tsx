    ...
    <main className="relative min-h-screen w-full overflow-hidden">
      ...
      >
        ...
        {!submitted && (
          ...
          >
            <h2
              className="text-center font-bold tracking-widest mb-3 text-base"
              style={{
                color: "#4a0e00",
                textShadow: "0 1px 4px rgba(255,220,150,0.7)",
              }}
            >
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    backgroundColor: "rgba(255,220,150,0.55)",
                    border: `2px solid ${errors.name ? "#cc0000" : "#c45e00"}`,
                    color: "#3a0a00",
                    backdropFilter: "blur(2px)",
                  }}
                />
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    backgroundColor: "rgba(255,220,150,0.55)",
                    border: `2px solid ${errors.email ? "#cc0000" : "#c45e00"}`,
                    color: "#3a0a00",
                    backdropFilter: "blur(2px)",
                  }}
                />
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    backgroundColor: "rgba(255,220,150,0.55)",
                    border: `2px solid ${errors.phone ? "#cc0000" : "#c45e00"}`,
                    color: "#3a0a00",
                    backdropFilter: "blur(2px)",
                  }}
                />
      ...
      >
        ...
        {/* Bottom */}
        <div
          className="fixed bottom-0 left-0 right-0 h-10 z-[9998] pointer-events-none"
          style={{
            backgroundColor: "#D4A017",
            backgroundImage: "url('/border-blue.png')",
            backgroundSize: "auto 100%",
              ...
              <div className="relative z-10 flex flex-col items-center justify-center w-full px-16 pt-32 pb-8">
                {submitted ? (
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <h3
                      className="font-taiganja text-2xl"
                      style={{ color: "#7B2D0E" }}
                    >
                      You&apos;re Registered!
                    </h3>
                            ...
                            onClick={() => {
                              if (customCollege.trim()) {
                                ...
                                localStorage.setItem(
                                  "customColleges",
                                  JSON.stringify(newCustomColleges),
                                );
                                setFormData({
                                  ...formData,
