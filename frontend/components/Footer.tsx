    ...
    >
      ...
      <div
        style={{
          height: 3,
          background:
            "linear-gradient(to right, transparent, #D4A017, #FF6B35, #D4A017, transparent)",
          position: "relative",
          zIndex: 3,
        }}
      />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-14 pb-8">
          ...
          <div className="text-center mb-12">
            <h2
              ...
              style={{
                ...
                textShadow: "0 2px 16px rgba(212,160,23,0.4)",
              }}
            >
              Crescendo&apos;26
            </h2>
            ...
            <div
              style={{
                ...
                width: 80,
                background:
                  "linear-gradient(to right, #8B1538, #D4A017, #8B1538)",
                margin: "12px auto 0",
              }}
            />
          </div>
                ...
                {(
                  ...
                  <li key={href}>
                    <Link
                      ...
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.color = "#F7B32B")
                      }
                      onMouseLeave={(e) =>
          ...
          <div
            style={{
              height: 1,
              background:
                "linear-gradient(to right, transparent, rgba(212,160,23,0.4), transparent)",
              marginBottom: 24,
            }}
          />
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-3">
            ...
            >
              © 2026 Crescendo — VIT&apos;s Inter-College Fest. All rights
              reserved.
            </p>
            <p
              style={{
